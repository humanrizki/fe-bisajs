function Welcome(){
    return (
        <div className='bisa-js__welcome text-center w-11/12 md:w-7/12 mx-auto my-[150px]'>
            ...
            <p className='text-lg w-10/12 mx-auto text-slate-800 dark:text-slate-400'>Platform ini gratis, tidak dipungut sepersen pun dalam materi. Hadapi materi dengan baik dan selalu support developer ya!</p>
            <div className='w-10/12 mx-auto mt-8 gap-x-5'>
                ...
                <button className='py-2 px-6 bg-transparent border border-slate-800'>Tur Teknologi</button>
            </div>
        </div>
    )
}
